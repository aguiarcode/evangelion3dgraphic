A 3D graphic renderer built from scratch using pure mathematical formulas. No WebGL, no WebGPU, no Canvas 3D context, no external rendering libraries. Just math and pixels.
